...
class ExpenseEditPage extends StatefulWidget {
  ...
  ExpenseEditPage({required this.expenseKey});
...
class _ExpenseEditPageState extends State<ExpenseEditPage> {
  ...
  void initState() {
    ...
    expenseDataModel = expenceController.expenseListdataBox!.get(widget.expenseKey);
    categoryExpenseModel =
        expenceController.categoryDataBox!.get(expenseDataModel!.categoryExpenseId);
    expensePriceController.text = expenseDataModel!.price;
    expenseDesController.text = expenseDataModel!.description;
    expenseLocationController.text = expenseDataModel!.location;
    selectedDate = intl.DateFormat("yyyy-MM-dd hh:mm:ss").parse(
        expenseDataModel!.dataKey); //DateTime.parse(expenseDataModel!.date);
  ...
  Widget build(BuildContext context) {
    print('newdate' + selectedDate.toString().substring(0, 10));
    print('olddate' + expenseDataModel!.dataKey);
                    ...
                    Expanded(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: expenseDataModel!.price,
                            hintStyle:
              ...
              Container(
                child: ListTile(
                  ...
                  title: TextFormField(
                    ...
                    textInputAction: TextInputAction.next,
                    decoration: InputDecoration(
                        hintText: expenseDataModel!.description,
                        hintStyle:
              ...
              Container(
                child: ListTile(
                  ...
                  title: TextFormField(
                    ...
                    decoration: InputDecoration(
                        hintText: expenseDataModel!.location,
                        hintStyle:
                            Theme.of(context).textTheme.headline6!.copyWith(
                                  color: Colors.white54,
                                ),
        ...
        onPressed: () {
          try {
            if (formKey.currentState!.validate()) {
              ...
              if (selectedDate.toString().substring(0, 10) ==
                  expenseDataModel!.dataKey.substring(0, 10)) {
                print('keysame');
                dateKey = expenseDataModel!.dataKey;
              } else {
                expenceController.expenseListdataBox!
                    .delete(expenseDataModel!.dataKey)
                    .then((value) {
                  print('value deleeted');
                });
                print('object deleted');
              }

              ExpenseDataModel _expenseDataModel = ExpenseDataModel(
                  categoryExpenseId: expenseDataModel!.categoryExpenseId,
                  ...
                  dataKey: dateKey);
              print(_expenseDataModel.categoryExpenseId.toString() +
                  '\n' +
                  _expenseDataModel.date +
                  '\n' +
                  _expenseDataModel.description +
                  '\n' +
                  _expenseDataModel.location +
                  '\n' +
                  _expenseDataModel.price);
              // .put('2021-06-15 16:15:39.856901', expenseDataModel)
              expenceController.expenseListdataBox!.put(dateKey, _expenseDataModel).then((value) {
